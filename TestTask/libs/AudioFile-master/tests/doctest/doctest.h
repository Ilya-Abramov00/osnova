...
struct ContextOptions //!OCLINT too many fields
{
    ...
    bool no_line_numbers;      // if lib code line numbers should be omitted from the output
...
namespace {
    ...
    bool fileOrderComparator(const TestCase* lhs, const TestCase* rhs) {
        ...
        // for __FILE__ when evaluated in a header and a lib file
...
// =================================================================================================
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "sf,  --" DOCTEST_OPTIONS_PREFIX_DISPLAY "lib-file=<filters>         "
              << Whitespace(sizePrefixDisplay*1) << "filters     tests by their file\n";
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "sfe, --" DOCTEST_OPTIONS_PREFIX_DISPLAY "lib-file-exclude=<filters> "
...
void Context::parseArgs(int argc, const char* const* argv, bool withDefaults) {
    ...
    // clang-format off
    parseCommaSepArgs(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "lib-file=",        p->filters[0]);
    parseCommaSepArgs(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "sf=",                 p->filters[0]);
    parseCommaSepArgs(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "lib-file-exclude=",p->filters[1]);
